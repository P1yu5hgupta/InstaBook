  ...
  const deletePost = () => {   
    ...
    return (
      <Card className={classes.card}>
        <CardHeader
            avatar={
              <Avatar src={'http://localhost:4000/api/users/photo/'+props.post.postedBy._id}/>
            }
            ...
            style={{'background-color':'rgb(100,100,100,0.5'}}
          />
